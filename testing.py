...
# Function to predict stress level for multiple files
def predict_stress_multiple(model_path, folder_path, scaler, class_mapping):
    """Load model and predict stress levels for multiple audio files in a folder."""
...
# Load Trained Model
# ==================
model_path = "D:/stress_detection_model.h5"
model = load_model(model_path)
